...
router.post("/", async (req, res) => {
  const { literId, babyName, literDOB, babyGender, petDescriptionId, babyPrice, babyStatus } = req.body;
  
  let babyPic1 = req.files[0]?req.files[0].filename:"";
  let babyPic2 = req.files[1]?req.files[1].filename:"";
  let babyPic3 = req.files[2]?req.files[2].filename:"";
  let babyPic4 = req.files[3]?req.files[3].filename:"";
  let babyPic5 = req.files[4]?req.files[4].filename:"";
  let babyPic6 = req.files[5]?req.files[5].filename:"";
  try {
    let baby = new Baby({
      literId,
      babyName,
...
router.put("/", async (req, res) => {
  const { babyId, literId, babyName, literDOB, babyGender, petDescriptionId, babyPic1,
